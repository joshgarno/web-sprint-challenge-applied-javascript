...
1. What is the DOM?
A. It is a document object model which is a construct of a web page viewed on a browser.

2. What is an event?
A. It is when a specifically defined action occurs.

3. What is an event listener?
A. It is a function that detects when a specified action occurs.

4. Why would we convert a NodeList into an Array?
A. To perform functions on the data that can only be done in an array.

5. What is a component?
A. It is a generated instance of a program that consists of javascrit, and/or css, and/or html to create that instance(s). 
